...
const StepEvidence = ({ captures, onOpenCam, onRemove }) => {
  const { validImages, setValidImages, isLoading, setIsLoading, formData } =
    ...
    <>
      <div className="animate-in fade-in slide-in-from-right-8 duration-500">
        ...
        >
          ...
          {formData.category && validImages && (
            <p className="text-sm text-slate-500">
              Auto-tagged Category:{" "}
              <span className="font-semibold text-slate-700">
                {validImages.prediction}
              </span>
            </p>
          )}
          {validImages && (
            <div className="fixed top-6 right-6 z-50 animate-bounce">
              <div className="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-6 py-4 rounded-2xl shadow-2xl flex items-center gap-3">
                ...
                <div>
                  <p className="font-bold">AI Category Detected</p>
          ...
          {validImages ? (
            ...
            <h2 className="text-sm text-slate-500 ">Auto-tags GPS & Time</h2>
          )}
        </div>
